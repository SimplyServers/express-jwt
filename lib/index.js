...
module.exports = function (options) {
  ...
  var payloadSanitizer = options.payloadSanitizer;
  ...
  var middleware = function (req, res, next) {
    ...
    async.waterfall([
      ...
      function sanitizePayload(result, callback) {
        if (payloadSanitizer && typeof payloadSanitizer === 'function') {
          payloadSanitizer(result, (err, sanitizedPayload) => {
            if (err) return callback(err);
            callback(null, sanitizedPayload);
          });
        } else {
